...
<!-- navigacioni-->
		...
		<nav id="bt-menu" class="bt-menu bt-menu-close" >
		        ...
		        <ul>
            <li>
                <a class="bt-icon icon-home" href="../index.html" >
...
<div id="form">
	...
	<section>
	<div id="kontakt"> <p>Për të na kontaktuar </br>Plotësoni formularin më poshtë</p> </div>
	<form id="theForm" class="simform" autocomplete="off" name="theForm" method="post" action="send.php">
	<div class="simform-inner">
	<ol class="questions">
				<ol class="questions">
					<li>
						<span><label for="q1">Emri juaj p.sh.Shaip</label></span>
			...
			new stepsForm( theForm, {
				onSubmit : function( form ) {
					...
					var messageEl = theForm.querySelector( '.final-message' );
						...
						messageEl.innerHTML = 'Suksese! Komenti juaj eshte derguar ne ekipen tone , kerkojme kohe per shqyretim'; 
